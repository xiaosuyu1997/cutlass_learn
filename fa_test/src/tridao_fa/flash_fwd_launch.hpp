...
(maybe because they need split files to support compile parallelism?)
*/
    ...
    HEADDIM_SWITCH(params.d, [&] {
      BOOL_SWITCH(params.is_causal, Is_causal, [&] {
        DROPOUT_SWITCH(params.p_dropout < 1.f, Is_dropout, [&] {
          using KernelTraits = typename Params2KernelTraits<kHeadDim, Is_dropout, elem_type>::Traits;
